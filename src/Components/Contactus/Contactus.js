                        ...
                        <div className="container">
                            ...
                            <div className="row">
                                <div className='col-lg-12 text-center'>
                                    <h2 className="font-weight-light mt-2 mb-5">Quick Contact</h2>
                                </div>
                                    ...
                                    <div className="contact-box ml-3">
                                        <form>
                                            <div className="row">
                                                ...
                                                <div className="d-flex justify-content-center">
                                                    <button className='btn btn-primary btn-lg btn-block contact-us-btn'>Submit <ArrowRightAltIcon /></button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
